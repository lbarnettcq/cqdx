({
    ...
    /*handleChange: function(component, event, helper) {
        ...
        console.log('DEBUG:PaymentsTable:Controller:handleChange:SUCCESS:', filterText,  helper.getView(component, 'searchValue'));
    },*/
    handleChange: function(component, event, helper) {
        ...
        console.log('DEBUG:PaymentsTable:Controller:handleChange', data['id'], data['action']);

        helper.handleChange(component, data);
    },
    handleClickRefresh: function(component, event, helper) {
        console.log('DEBUG:PaymentsTable:Controller:handleClickRefresh:SUCCESS:');
    },
    handleClickFilter: function(component, event, helper) {
        console.log('DEBUG:PaymentsTable:Controller:handleClickFilter:SUCCESS:');
    },
    handleSaveEdition: function (cmp, event, helper) {
        let draftValues = event.getParam('draftValues');
        console.log('DEBUG:PaymentsTable:Controller:handleSaveEdition:', draftValues);
    },
    handleCancelEdition: function (cmp) {
        console.log('DEBUG:PaymentsTable:Controller:handleCancelEdition:');
    }
})