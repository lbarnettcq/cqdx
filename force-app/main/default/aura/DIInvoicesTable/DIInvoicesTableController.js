({
    ...
    /*handleChange: function(component, event, helper) {
        ...
        console.log('DEBUG:InvoicesTable:Controller:handleChange:SUCCESS:', filterText,  helper.getView(component, 'searchValue'));
    },*/
    handleChange: function(component, event, helper) {
        ...
        console.log('DEBUG:InvoicesTable:Controller:handleChange', data['id'], data['action']);

        helper.handleChange(component, data);
    },
    handleClickRefresh: function(component, event, helper) {
        console.log('DEBUG:InvoicesTable:Controller:handleClickRefresh:SUCCESS:');
    },
    handleClickFilter: function(component, event, helper) {
        console.log('DEBUG:InvoicesTable:Controller:handleClickFilter:SUCCESS:');
    },
    handleSaveEdition: function (cmp, event, helper) {
        let draftValues = event.getParam('draftValues');
        console.log('DEBUG:InvoicesTable:Controller:handleSaveEdition:', draftValues);
    },
    handleCancelEdition: function (cmp) {
        console.log('DEBUG:InvoicesTable:Controller:handleCancelEdition:');
    }
})